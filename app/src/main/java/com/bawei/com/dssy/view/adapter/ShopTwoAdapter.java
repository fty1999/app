 ...
 * @Description:
 */
public class ShopTwoAdapter extends RecyclerView.Adapter<ShopTwoAdapter.MyViewHolder> {

    private Context context;
    private List<ShopBean.ResultBean.MlssBean.CommodityListBeanXX> mList = new ArrayList<>();

    public ShopTwoAdapter(Context context) {
        this.context = context;
    }
    public void setDatae(List<ShopBean.ResultBean.MlssBean.CommodityListBeanXX> list){
        mList.addAll(list);
